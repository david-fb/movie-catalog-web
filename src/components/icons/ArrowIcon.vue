<script setup>
	const props = defineProps(['rotate'])
</script>
<template>
<svg version="1.1" id="Layer_1" x="0px" y="0px" width="40" height="40" fill="rgba(250,250,250, .3)"
	 viewBox="0 0 330 330" :transform="'rotate(' + props.rotate + ')'" xml:space="preserve">
<g id="XMLID_13_">
