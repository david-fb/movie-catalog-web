...
<template>
<svg version="1.1" id="Layer_1" x="0px" y="0px" @click.stop="addFavotire"
	 viewBox="0 0 476.213 476.213" style="enable-background:new 0 0 476.213 476.213;" fill="#f6c434" xml:space="preserve">
